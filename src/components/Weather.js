        ...
        setWeather({
          ...
          hourly: response.data.timelines[1].intervals.slice(0, 25).map((hourlyForecast) => {
            ...
            hourlyConditions = {
              ...
              temperature: Math.floor(hourlyConditions.temperature) + "\xB0F",
          ...
          daily: response.data.timelines[0].intervals.map((dailyForecast) => {
            ...
            dailyConditions = {
              ...
              temperatureMax: Math.floor(dailyConditions.temperatureMax) + "\xB0F",
              temperatureMin: Math.floor(dailyConditions.temperatureMin) + "\xB0F",
